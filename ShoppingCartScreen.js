    ...
    <ScrollView style={{ flex: 1, backgroundColor: "#fff", padding: 20 }}>
      ...
      <ImageBackground 
        ...
        <View style={{ flexDirection: "row", justifyContent: "center", marginTop: -20 }}>
          <Image source={require("./assets/burger(3).png")} style={{ width: 70, height: 70, borderRadius: 10, marginHorizontal: 10 }} />
          <Image source={require("./assets/burger(2).png")} style={{ width: 70, height: 70, borderRadius: 10, marginHorizontal: 10 }} />
          <Image source={require("./assets/burger(1).png")} style={{ width: 70, height: 70, borderRadius: 10, marginHorizontal: 10}} />
        </View>
        </ImageBackground>
      </View>
